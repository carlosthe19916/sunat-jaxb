...
@javax.xml.bind.annotation.XmlSchema(namespace = "urn:oasis:names:specification:ubl:schema:xsd:DebitNote-2", elementFormDefault = javax.xml.bind.annotation.XmlNsForm.QUALIFIED, xmlns = {
...
//        @XmlNs(namespaceURI = "urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2", prefix = "ext"),
        ...
        @XmlNs(namespaceURI = "urn:oasis:names:specification:ubl:schema:xsd:DebitNote-2", prefix = ""),
