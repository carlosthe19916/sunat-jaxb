...
import io.github.carlosthe19916.beans.ubl.ubl21.DebitNote21BeanBuilder;
...
public class DebitNoteFacadeTest {
    ...
    @Test
    public void DebitNoteFacade() {

        DebitNote21Bean build= DebitNote21BeanBuilder.builder()
                ...
                .documentoRelacionado()
                    ...
                    .tipoNotaDebito(Catalogo10.INTERES)
...
//                    .end()
        ...
        DebitNote21Bean note21Bean = DebitNoteFacade.fillOut(build);

        try {
            DebitNoteType noteType = DebitNoteFacade.toDebitNoteType(note21Bean);

            MapBasedNamespaceContext mapBasedNamespace = getBasedNamespaceContext("urn:oasis:names:specification:ubl21:schema:xsd:DebitNote-2");
            ByteArrayOutputStream out = new ByteArrayOutputStream();

            UBL21WriterBuilder<DebitNoteType> builder = UBL21Writer.debitNote();
            ...
            FileWriter writer = new FileWriter(new File("D:/DebitNoteSample.xml"));
