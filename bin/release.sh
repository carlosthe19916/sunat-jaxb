...
git push "https://$username:$password@github.com/carlosthe19916/sunat-jaxb.git"

# Create tag and push
git tag "$releaseVersion"
git push "https://$username:$password@github.com/carlosthe19916/sunat-jaxb.git" --tags
